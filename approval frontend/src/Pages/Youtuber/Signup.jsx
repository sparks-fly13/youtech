...
function YoutuberSignup() {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const {data} = await axios.post('/youtuber/signup', {
                email,
                password,
                name
            });
        ...
        <Flex mt={20} width="full" align="center" justifyContent="center">
            <Box width="xl" p={8} borderWidth={1} borderRadius={13} borderColor="aliceblue" boxShadow="lg">
                <Box textAlign="center" fontSize="xl">
                    <h1><strong>Signup</strong> as Youtuber</h1>
                </Box>
                ...
                <Box>
                    <p>Already have an account?
                        <Link as={ReactRouterLink} to="/youtuber/login" color="teal.500" ml={2}>Login</Link>
                    </p>
                </Box>
            </Box>
        </Flex>
